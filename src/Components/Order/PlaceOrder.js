      ...
      <FlexCol margin="44px 0 0 0" align="flex-start" width="1516px">
        ...
        <FlexRow align="center" width="55%" margin="0 0 36px">
          <FlexRow justify="flex-start">
            ...
            <Text fontSize="22px" weight="700" marginA="0 0 0 10px" color="#00000080">
          ...
          >
            ...
            <FlexRow justify="space-between">
              <FlexCol align="flex-start" width="48%">
                ...
                <Text width="250px" fontSize="16px" weight="700" color="#707070" marginA="0 0 40px" lineHeight="1.8">
            ...
            >
              <Text fontSize="24px" weight="700" marginA="0 0 20px 0">Order Details</Text>
            ...
            <FlexRow margin="0 0 20px" height="96px">
              ...
              <FlexCol padding="0 22px 35px 22px" align="flex-start">
                <Text align="flex-start" color="#70707095" fontSize="16px" weight="700" marginA="0 0 30px">iPhone 11 Pro
                  256GB Memory</Text>
                <FlexRow justify="space-between">
                  <Text color="#70707095" fontSize="16px" weight="700">$499.99 <Span
                    margin="0 0 0 10px">×1</Span></Text>
                  <Text color="#242424" fontSize="16px" weight="700">$89.99</Text>
                </FlexRow>
              </FlexCol>
            </FlexRow>
            <FlexRow margin="0 0 20px" height="96px">
              <Image src={} width="135px" />
              <FlexCol padding="0 22px 35px 22px" align="flex-start">
                <Text align="flex-start" color="#70707095" fontSize="16px" weight="700" marginA="0 0 30px">Apple Airpods
                  Wireless Bluetooth Headset</Text>
                <FlexRow justify="space-between">
                  <Text color="#70707095" fontSize="16px" weight="700">$89.99 <Span margin="0 0 0 10px">×1</Span></Text>
                  <Text color="#242424" fontSize="16px" weight="700">$89.99</Text>
                </FlexRow>
              </FlexCol>
            </FlexRow>
            ...
            <FlexRow justify="space-between" align="baseline"
            >
              <Text fontSize="24px" weight="700" marginA="0 0 20px 0">Payment Details</Text>
              <Text borderB=" 1px solid #707070" color="#70707095" fontSize="22px" weight="700">Change</Text>
            </FlexRow>
            <FlexRow justify="start" align="center"
            >
              <Image src={} width="80px" />
              <Text color="#70707095" fontSize="16px" weight="700">**** 1245</Text>
            </FlexRow>
          </FlexCol>
